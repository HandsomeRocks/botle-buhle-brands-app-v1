...
import 'interview_guidev1_copy_model.dart';
export 'interview_guidev1_copy_model.dart';

class InterviewGuidev1CopyWidget extends StatefulWidget {
  const InterviewGuidev1CopyWidget({
    super.key,
  ...
  @override
  State<InterviewGuidev1CopyWidget> createState() =>
      _InterviewGuidev1CopyWidgetState();
}

class _InterviewGuidev1CopyWidgetState extends State<InterviewGuidev1CopyWidget>
    with TickerProviderStateMixin {
  late InterviewGuidev1CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InterviewGuidev1CopyModel());
