...
import 'recruit_attendance_backup_model.dart';
export 'recruit_attendance_backup_model.dart';

class RecruitAttendanceBackupWidget extends StatefulWidget {
  const RecruitAttendanceBackupWidget({
    super.key,
    this.attendeeid,
  });
  ...
  @override
  State<RecruitAttendanceBackupWidget> createState() =>
      _RecruitAttendanceBackupWidgetState();
}

class _RecruitAttendanceBackupWidgetState
    extends State<RecruitAttendanceBackupWidget> with TickerProviderStateMixin {
  late RecruitAttendanceBackupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecruitAttendanceBackupModel());
