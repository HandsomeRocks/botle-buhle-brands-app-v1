...
import '/components/interview_decline_reasons_widget.dart';
import '/components/interview_guide_embed_widget.dart';
...
import 'interview_page2_widget.dart' show InterviewPage2Widget;
...
class InterviewPage2Model extends FlutterFlowModel<InterviewPage2Widget> {
  ...
  // Stores action output result for [Backend Call - API (Update Odoo Prospective  ConsumerviewDetails)] action in Button widget.
  ApiCallResponse? odooPCUpdateRes;
  // Stores action output result for [Backend Call - API (Update Prospective  Interview Status)] action in Button widget.
  ApiCallResponse? interviewStatusRes;
