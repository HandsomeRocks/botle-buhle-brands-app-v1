...
import 'onboardin_page1_backup_model.dart';
export 'onboardin_page1_backup_model.dart';

class OnboardinPage1BackupWidget extends StatefulWidget {
  const OnboardinPage1BackupWidget({
    super.key,
    this.creditscore,
  ...
  @override
  State<OnboardinPage1BackupWidget> createState() =>
      _OnboardinPage1BackupWidgetState();
}

class _OnboardinPage1BackupWidgetState extends State<OnboardinPage1BackupWidget>
    with TickerProviderStateMixin {
  late OnboardinPage1BackupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardinPage1BackupModel());
                                ...
                                Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final onboardRecruitsListGetOnboardedListAcceptedResponse =
                                          snapshot.data!;
                                      return Builder(
                                        builder: (context) {
                                          final allRecruits =
                                              GetOnboardedListAcceptedCall
                                                      .allOnboardees(
                                                    onboardRecruitsListGetOnboardedListAcceptedResponse
                                                        .jsonBody,
                                                  )?.toList() ??
                                                  [];
